...
CPAL uses **OpenReview** to host submissions, reviews, author responses, and discussion. The two submission tracks have distinct anonymity and publication rules; please consult the [Submission Tracks]({{ site.baseurl }}/tracks/) page before reviewing.
